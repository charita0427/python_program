...
print("First mark:", marks[0]) #start of the marks
print("Last mark:", marks[-1]) #end of the marks
 
first_three_marks = marks[0:3] # 0 = the start, : = stop, 3 = go in order
